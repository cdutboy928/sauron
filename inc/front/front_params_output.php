 ...
 */
  ...
  */
  ...
  public function color_control(){
    ...
    $menu_color = $this->get_param('[colors_active][colors][menu_color][value]', array(), "#FFFFFF");
    ...
    #menu-button-block {
      border-bottom: 3px solid <?php echo $logo_text_color;?> !important;
    }
    #sidebar1, #sidebar2{
    ...
    #wd-categories-tabs ul.content > li ul li div.thumbnail-block, .round {
      border: 10px solid <?php echo $logo_text_color; ?>;
    }
    #social_icons .fa{
      color:<?php echo $logo_text_color; ?>;
    }
